/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bebe2864b79ea72770723a5e330e11bd)
// Runtime types generated with workerd@1.20250428.0 2025-03-10 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		OPENAPI_KEY: string;
		MyAgent: DurableObjectNamespace<import("./src/client").MyAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAPI_KEY">> {}
}
