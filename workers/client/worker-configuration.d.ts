/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eadf56f0fffb5ddafe97c246c0c11441)
// Runtime types generated with workerd@1.20250428.0 2025-03-10 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		OPENAPI_KEY: string;
		AUTHLESS_MCP_SERVER_ADDRESS: string;
		OAUTH_MCP_SERVER_ADDRESS: string;
		CLIENT_SERVER_ADDRESS: string;
		McpClient: DurableObjectNamespace<import("./src/client").McpClient>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAPI_KEY" | "AUTHLESS_MCP_SERVER_ADDRESS" | "OAUTH_MCP_SERVER_ADDRESS" | "CLIENT_SERVER_ADDRESS">> {}
}
