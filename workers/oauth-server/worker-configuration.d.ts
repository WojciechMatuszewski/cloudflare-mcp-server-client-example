/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f2c1a1258409e34b41cf7538ecdb8d3c)
...
declare namespace Cloudflare {
	interface Env {
		...
		MCP_OBJECT: DurableObjectNamespace<import("./server/server").OAuthMCPServer>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STYTCH_PROJECT_ID" | "STYTCH_CLIENT_SECRET" | "STYTCH_CLIENT_ID">> {}
}
