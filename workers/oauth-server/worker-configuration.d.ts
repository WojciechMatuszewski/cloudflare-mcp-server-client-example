/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1b38620d64e2873861cd587f184e07d6)
// Runtime types generated with workerd@1.20250428.0 2025-03-10 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		STYTCH_PROJECT_ID: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/server").OAuthMCPServer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STYTCH_PROJECT_ID">> {}
}
